...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section>
        <img src="imgs/home-bg5.jpg" class="img-fluid" />
    </section>
      ...
      <div class="container">
         ...
         <div class="row">
            <div class="col-md-4">
               <center>
                   <img width="150px" src="imgs/digital-inventory2.png" />
            ...
            <div class="col-md-4">
               <center>
                   <img width="150px" src="imgs/rent-car2.png" />
                  <h4>Rent Car</h4>
                  <p class="text-justify">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
               </center>
            </div>
       ...
       <section>
           <img src="imgs/home-bg8.jpg" class="img-fluid" />
   </section>
